...
) -> List[Tuple[str, SpectraBooleanSpecification]]:
...
def get_files_with_specs_from_directory(
    ...
    files_with_specs = [
        (spec_file_path, SpectraBooleanSpecification.from_file(os.path.join(spec_directory_path, spec_file_path)))
...
def filter_semantically_unique_specifications(
        files_with_specs: List[Tuple[str, SpectraBooleanSpecification]],
        comparison_type: Optional[GR1FormulaType] = None
) -> List[Tuple[str, SpectraBooleanSpecification]]:
...
def filter_maximal_specifications(
        files_with_specs: List[Tuple[str, SpectraBooleanSpecification]],
        semantically_unique_files_with_specs: Optional[List[Tuple[str, SpectraBooleanSpecification]]] = None,
        comparison_type: Optional[GR1FormulaType] = None
) -> List[Tuple[str, SpectraBooleanSpecification]]:
    """
