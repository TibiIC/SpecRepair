...
#   LEARNER_TIMEOUT=900 ./run_case_study_2.sh    # seconds per learning task (default 600)
#
...
# ILASP: 2,671 learning tasks across the three ILASP sweeps hit it (927 in this
