# minepump_liveness - trace 2

- target assumption: `assumption1_1`
- our run recorded these as violated: `assumption1_1`
...
| --- | --- | --- |
| 0 | highwater=false  methane=false | pump=false  flag=false |
| 1 | highwater=true  methane=true | pump=true  flag=true |
| 2 | highwater=true  methane=true | pump=false  flag=true |
| 3 | highwater=true  methane=false | pump=false  flag=true |
| 4 | highwater=true  methane=false | pump=true  flag=true |
| 5 | highwater=true  methane=true | pump=true  flag=true |
| 6 | highwater=true  methane=false | **? <- the controller's answer goes here** |
