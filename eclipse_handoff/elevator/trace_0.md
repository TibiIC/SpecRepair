...
| --- | --- | --- |
| 0 | floor_lower=false  floor_middle=true  floor_upper=false | elevMot_fwd=false  elevMot_bwd=false |
| 1 | floor_lower=false  floor_middle=true  floor_upper=false | elevMot_fwd=true  elevMot_bwd=false |
| 2 | floor_lower=true  floor_middle=false  floor_upper=false | elevMot_fwd=true  elevMot_bwd=false |
...
| 5 | floor_lower=true  floor_middle=true  floor_upper=false | **? <- the controller's answer goes here** |

## The violating environment input

```
floor_lower=true  floor_middle=true  floor_upper=false
```
