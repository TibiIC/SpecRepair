# elevator - trace 1 (incomplete)

- target assumption: `stopped_implies_floor_known`
- steps 0-7 are genuine controller output
- step 8 is the intended violation, and its system response is unknown
...
| 2 | floor_lower=true  floor_middle=false  floor_upper=false | elevMot_fwd=false  elevMot_bwd=true |
| 3 | floor_lower=false  floor_middle=true  floor_upper=false | elevMot_fwd=false  elevMot_bwd=false |
| 4 | floor_lower=false  floor_middle=true  floor_upper=false | elevMot_fwd=true  elevMot_bwd=false |
| 5 | floor_lower=false  floor_middle=false  floor_upper=false | elevMot_fwd=true  elevMot_bwd=false |
| 6 | floor_lower=false  floor_middle=false  floor_upper=false | elevMot_fwd=false  elevMot_bwd=true |
| 7 | floor_lower=false  floor_middle=false  floor_upper=false | elevMot_fwd=false  elevMot_bwd=false |
| 8 | floor_lower=true  floor_middle=true  floor_upper=true | **? <- the controller's answer goes here** |
