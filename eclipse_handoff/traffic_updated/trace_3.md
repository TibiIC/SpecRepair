# traffic_updated - trace 3

- target assumption: `carB_moves_when_green`
- our run recorded these as violated: `carB_moves_when_green`
...
| --- | --- | --- |
| 0 | carA=false  carB=false  emergency=false | greenA=true  greenB=false |
| 1 | carA=true  carB=true  emergency=true | greenA=false  greenB=false |
| 2 | carA=false  carB=false  emergency=true | greenA=false  greenB=false |
| 3 | carA=false  carB=false  emergency=true | greenA=false  greenB=false |
| 4 | carA=true  carB=false  emergency=true | greenA=false  greenB=false |
| 5 | carA=false  carB=true  emergency=false | greenA=true  greenB=false |
| 6 | carA=true  carB=true  emergency=false | greenA=false  greenB=true |
