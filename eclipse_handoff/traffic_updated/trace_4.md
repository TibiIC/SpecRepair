...
| --- | --- | --- |
| 0 | carA=false  carB=false  emergency=true | greenA=false  greenB=false |
| 1 | carA=true  carB=true  emergency=true | greenA=false  greenB=false |
| 2 | carA=true  carB=false  emergency=true | greenA=false  greenB=false |
| 3 | carA=false  carB=false  emergency=false | greenA=true  greenB=false |
| 4 | carA=true  carB=true  emergency=false | greenA=false  greenB=true |
| 5 | carA=false  carB=false  emergency=true | **? <- the controller's answer goes here** |
