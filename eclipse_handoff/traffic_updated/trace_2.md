# traffic_updated - trace 2

- target assumption: `carB_idle_when_red`
- our run recorded these as violated: `carB_idle_when_red`
...
| --- | --- | --- |
| 0 | carA=true  carB=false  emergency=true | greenA=false  greenB=false |
| 1 | carA=true  carB=false  emergency=true | greenA=false  greenB=false |
| 2 | carA=false  carB=false  emergency=false | greenA=false  greenB=true |
| 3 | carA=true  carB=false  emergency=true | greenA=false  greenB=false |
| 4 | carA=false  carB=true  emergency=true | greenA=false  greenB=false |
| 5 | carA=false  carB=false  emergency=false | **? <- the controller's answer goes here** |
