...
| 1 | distSense_blocked=true  isReady=true | balancer_fwd=false  balancer_bwd=false  balancer_turn_left=true  balancer_turn_right=false |
| 2 | distSense_blocked=true  isReady=true | balancer_fwd=false  balancer_bwd=false  balancer_turn_left=false  balancer_turn_right=true |
| 3 | distSense_blocked=false  isReady=true | balancer_fwd=true  balancer_bwd=false  balancer_turn_left=false  balancer_turn_right=false |
...
| 5 | distSense_blocked=true  isReady=false | **? <- the controller's answer goes here** |
