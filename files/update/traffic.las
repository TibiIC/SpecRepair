...
:- head(antecedent_exception(carA_idle_when_red,V1,V2)), body(holds_at(eventually,_,_,_)).
:- head(antecedent_exception(carA_idle_when_red,V1,V2)), body(not_holds_at(eventually,_,_,_)).
:- head(antecedent_exception(carB_idle_when_red,V1,V2)), body(holds_at(eventually,_,_,_)).
:- head(antecedent_exception(carB_idle_when_red,V1,V2)), body(not_holds_at(eventually,_,_,_)).
:- head(antecedent_exception(carA_idle_when_red,V1,V2)), body(holds_at(current,carA,V1,V2)).
:- head(antecedent_exception(carA_idle_when_red,V1,V2)), body(not_holds_at(current,greenA,V1,V2)).
:- head(antecedent_exception(carB_idle_when_red,V1,V2)), body(holds_at(current,carB,V1,V2)).
:- head(antecedent_exception(carB_idle_when_red,V1,V2)), body(not_holds_at(current,greenB,V1,V2)).
...
antecedent_holds(carA_idle_when_red,T,S):-
	...
	not antecedent_exception(carA_idle_when_red,T,S).
...
antecedent_holds(carB_idle_when_red,T,S):-
	...
	not antecedent_exception(carB_idle_when_red,T,S).
...
antecedent_holds(carA_moves_when_green,T,S):-
	trace(S),
	timepoint(T,S),
	root_antecedent_holds(prev,carA_moves_when_green,T,0,S).

root_antecedent_holds(OP,carA_moves_when_green,T,0,S):-
    temporal_operator(OP),
    holds_at(OP,carA,T,S),
...
antecedent_holds(carB_moves_when_green,T,S):-
	trace(S),
	timepoint(T,S),
	root_antecedent_holder(current,carB_moves_when_green,0,T,S).
