...
:- head(consequent_exception(guarantee1_1,V1,V2)), body(holds_at(current,_,_,_)).
:- head(consequent_exception(guarantee1_1,V1,V2)), body(not_holds_at(current_,_,_,_)).
:- head(consequent_exception(guarantee2_1,V1,V2)), body(holds_at(current,_,_,_)).
:- head(consequent_exception(guarantee2_1,V1,V2)), body(not_holds_at(current_,_,_,_)).
:- head(consequent_exception(guarantee3_1,V1,V2)), body(holds_at(eventually,_,_,_)).
:- head(consequent_exception(guarantee3_1,V1,V2)), body(not_holds_at(eventually,_,_,_)).
:- head(consequent_exception(guarantee4,V1,V2)), body(holds_at(eventually,_,_,_)).
:- head(consequent_exception(guarantee4,V1,V2)), body(not_holds_at(eventually,_,_,_)).
:- head(consequent_exception(guarantee1_1,V1,V2)), body(holds_at(eventually,g1,V1,V2)).
:- head(consequent_exception(guarantee2_1,V1,V2)), body(holds_at(eventually,g2,V1,V2)).
:- head(consequent_exception(guarantee3_1,V1,V2)), body(not_holds_at(current,g1,V1,V2)).
:- head(consequent_exception(guarantee3_1,V1,V2)), body(not_holds_at(current,g2,V1,V2)).
:- head(consequent_exception(guarantee4,V1,V2)), body(not_holds_at(current,g1,V1,V2)).
:- head(consequent_exception(guarantee4,V1,V2)), body(not_holds_at(current,g2,V1,V2)).
...
antecedent_holds(guarantee2_1,T,S):-
	trace(S),
	timepoint(T,S),
	holds_at(current,r2,T,S).

consequent_holds(eventually,guarantee2_1,T,S):-
	trace(S),
	timepoint(T,S),
	root_consequent_holds(eventually,guarantee2_1,T,S).
...
root_consequent_holds(OP,guarantee3_1,T,S):-
	...
	timepoint(T,S),
	temporal_operator(OP),
	consequent_exception(guarantee3_1,T,S).
...
root_consequent_holds(OP,guarantee4,T,S):-
	...
	timepoint(T,S),
	temporal_operator(OP),
	consequent_exception(guarantee4,T,S).
root_consequent_holds(OP,guarantee4,T,S):-
	trace(S),
	timepoint(T,S),
	temporal_operator(OP),
...
#pos({entailed(counter_strat_0_5)},{},{
