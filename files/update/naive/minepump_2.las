...
:- head(consequent_exception(initial_guarantee,V1,V2)), body(holds_at(eventually,_,_,_)).
:- head(consequent_exception(initial_guarantee,V1,V2)), body(not_holds_at(eventually,_,_,_)).
...
:- head(consequent_exception(_,_,_)), body(root_consequent_holds_0(_,_,_,_)).
...
consequent_holds(current,initial_guarantee,0,S):-
	trace(S),
	timepoint(0,S),
	root_consequent_holds_0(current,initial_guarantee,0,S),
	not ev_temp_op(initial_guarantee).

root_consequent_holds_0(OP,initial_guarantee,0,S):-
	temporal_operator(OP),
...
antecedent_holds(guarantee1_1,T,S):-
	trace(S),
	timepoint(T,S),
	root_antecedent_holds_0(current,guarantee1_1,T,S).

root_antecedent_holds_0(OP,guarantee1_1,T,S):-
    trace(S),
    timepoint(T,S),
    temporal_operator(OP),
...
consequent_holds(next,guarantee1_1,T,S):-
	trace(S),
	timepoint(T,S),
	root_consequent_holds_0(next,guarantee1_1,T,S),
	not ev_temp_op(guarantee1_1).

root_consequent_holds_0(OP,guarantee1_1,T,S):-
	trace(S),
	timepoint(T,S),
	temporal_operator(OP),
...
antecedent_holds(guarantee2_1,T,S):-
	trace(S),
	timepoint(T,S),
	root_antecedent_holds_0(current,guarantee2_1,T,S).

root_antecedent_holds_0(OP,guarantee2_1,T,S):-
    trace(S),
    timepoint(T,S),
    temporal_operator(OP),
...
consequent_holds(next,guarantee2_1,T,S):-
	trace(S),
	timepoint(T,S),
	root_consequent_holds_0(next,guarantee2_1,T,S),
	not ev_temp_op(guarantee2_1).

root_consequent_holds_0(OP,guarantee2_1,T,S):-
	trace(S),
	timepoint(T,S),
	temporal_operator(OP),
