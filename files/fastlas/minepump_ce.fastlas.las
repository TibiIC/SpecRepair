...
#bias("
:- in_head(consequent_exception(_,V1,V2)), in_body(timepoint_of_op(_,V3,_,V4)), (V1, V2) != (V3, V4).
:- in_head(consequent_exception(_,_,V1)), in_body(holds_at(_,_,V2)), V1 != V2.
:- in_head(consequent_exception(_,_,V1)), in_body(not_holds_at(_,_,V2)), V1 != V2.
...
:- in_head(consequent_exception(_,_,_)), in_body(timepoint_of_op(prev,_,_,_)).
:- in_head(consequent_exception(_,_,_)), in_body(timepoint_of_op(eventually,_,_,_)).
:- in_head(consequent_exception(_,_,_)), in_body(timepoint_of_op(next,_,_,_)), in_body(holds_at(pump,_,_)).
:- in_head(consequent_exception(_,_,_)), in_body(timepoint_of_op(next,_,_,_)), in_body(not_holds_at(pump,_,_)).
").
