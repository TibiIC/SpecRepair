...
#modeh(ev_temp_op(const(cons_node))).
...
w_eventually(f_consequent, f_ev_temp_step) :- ev_temp_op(f_consequent).
disjunction(f_ev_temp_step, f_consequent_conjunct_0) :- ev_temp_op(f_consequent).
disjunction(f_consequent, f_consequent_conjunct_0) :- not ev_temp_op(f_consequent).
