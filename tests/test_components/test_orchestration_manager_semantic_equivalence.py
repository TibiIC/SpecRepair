...
class TestOrchestrationManagerSemanticEquivalence(BaseTestCase):
    ...
    def test_enqueue_new_tasks_semantically_equivalent(self):
        ...
        self.assertEqual(len(om._visited_nodes_list), 2)
    ...
    def test_enqueue_new_tasks_different(self):
        ...
        self.assertEquals(om._visited_nodes_list[1][0].to_str(), spec_2.to_str())
        self.assertEquals(om._visited_nodes_list[1][1], ([ct2], Learning.ASSUMPTION_WEAKENING))
