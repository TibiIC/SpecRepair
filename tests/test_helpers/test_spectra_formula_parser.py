...
class TestSpectraFormulaParser(TestCase):
    ...
    def test_parse_or(self):
        ...
        self.assertEqual(parsed.left._name, "highwater")
        self.assertEqual(parsed.right._name, "pump")
    ...
    def test_parse_globally(self):
        ...
        self.assertEqual(parsed.formula._name, "highwater")
    ...
    def test_parse_nested_expression(self):
        ...
        self.assertEqual(parsed.right.left._name, "q")
        self.assertEqual(parsed.right.left.value, False)
        self.assertEqual(parsed.right.right._name, "r")
    ...
    def test_parse_nested_expression_with_eventually(self):
        ...
        self.assertEqual(parsed.right.formula.left._name, "q")
        self.assertEqual(parsed.right.formula.left.value, False)
        self.assertEqual(parsed.right.formula.right._name, "r")
    ...
    def test_parse_deeply_nested_expression(self):
        ...
        self.assertEqual(parsed.formula.left._name, "highwater")
        self.assertEqual(parsed.formula.left.value, True)
        self.assertIsInstance(parsed.formula.right, Next)
        self.assertEqual(parsed.formula.right.formula._name, "pump")
    ...
    def test_parse_deeply_nested_expression_prev(self):
        ...
        self.assertEqual(parsed.formula.left.left.formula._name, "pump")
        self.assertEqual(parsed.formula.left.left.formula.value, True)
        self.assertEqual(parsed.formula.left.right._name, "pump")
        self.assertEqual(parsed.formula.left.right.value, True)
        self.assertEqual(parsed.formula.right._name, "highwater")
    ...
    def test_parse_disjunction(self):
        ...
        self.assertEqual(parsed.left.left._name, "highwater")
        self.assertEqual(parsed.left.left.value, True)
        self.assertEqual(parsed.left.right._name, "methane")
    ...
    def test_parse_dnf(self):
        ...
        self.assertIsInstance(parsed, Or)
        self.assertIsInstance(parsed.left, And)
        self.assertEqual(parsed.left.left._name, "a")
        self.assertEqual(parsed.left.left.value, True)
        self.assertEqual(parsed.left.right._name, "b")
        self.assertEqual(parsed.left.right.value, False)
        self.assertIsInstance(parsed.right, And)
        self.assertEqual(parsed.right.left._name, "c")
        self.assertEqual(parsed.right.left.value, True)
        self.assertEqual(parsed.right.right._name, "d")
    ...
    def test_parse_nested_implication(self):
        ...
        self.assertEqual(parsed.right.left._name, "methane")
        self.assertEqual(parsed.right.left.value, False)
        self.assertEqual(parsed.right.right._name, "pump")
        self.assertEqual(parsed.right.right.value, True)
    ...
    def test_parse_ignore_optional_tab_and_semicolumn(self):
        ...
        self.assertEqual(parsed.formula.right._name, "methane")
        self.assertEqual(parsed.formula.right.value, False)
    ...
    def test_parse_real_example_lift(self):
        ...
        self.assertIsInstance(parsed, Globally)
        self.assertIsInstance(parsed.formula, Implies)
        self.assertEqual(parsed.formula.left._name, "f2")
        self.assertEqual(parsed.formula.left.value, True)
        ...
        self.assertEqual(parsed.formula.right.left.left.left.left.formula._name, "f1")
        self.assertEqual(parsed.formula.right.left.left.left.right._name, "b1")
        ...
        self.assertEqual(parsed.formula.right.left.left.right.left.left.formula._name, "f2")
        self.assertIsInstance(parsed.formula.right.left.left.right.left.right, Not)
        self.assertEqual(parsed.formula.right.left.left.right.left.right.formula._name, "b1")
        self.assertIsInstance(parsed.formula.right.left.left.right.right, Not)
        self.assertEqual(parsed.formula.right.left.left.right.right.formula._name, "b3")
