...
from pyparsing import Word, alphas, opAssoc, infixNotation, alphanums, Literal
...
class SpectraFormulaParser(ILTLParser):
    ...
    def __init__(self):
        ...
        # Support parsing atoms with values (e.g., a=false, b=1)
        self.operand = (identifier + equals + value).setParseAction(self._parse_atomic) | identifier.setParseAction(
            self._parse_atomic)
